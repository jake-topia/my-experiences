...
class CardViewManager extends SystemScript {
    ...
    drawMyHand(allPlayerHands) {
        ...
        var buffer = 10, totalHandWidth = handSize * (this.cardWidth + buffer);
    ...
    drawSuitSelector() {
        ...
        for (var i = 0; i < suits.length; i++) {
            ...
            if (artDetails.suitIcon) {
                ...
                if (icon)
                    this._suitSelectorIds.push(icon.uniqueId);
            }
        }
    }
    /**
    ...
    drawCardBack(baseId, x, y, w, h, rotation, isInteractive) {
        var cardBack = spriteManager.addSprite('blank_card', this._prune({
            uniqueId: baseId,
            positionX: x,
            positionY: y,
            width: w,
