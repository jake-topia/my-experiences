...
class ScoreManager extends SystemScript {
    ...
    onInit() {
        console.log("ScoreManager onInit: Attempting to create score text sprite...");
        ...
        try {
            ...
            if (sprite) {
                ...
                console.log("!!! ScoreManager FAILURE: Failed to create score text sprite!");
            }
        }
        catch (e) {
            console.log("!!! ScoreManager CRITICAL ERROR during score text creation:", e);
        }
        console.log("ScoreManager onInit completed.");
    }
    // --- Methods Called by GameManager ---
    displayMessage(message, xPos = this.positionX) {
        if (!this.scoreTextSprite)
            return;
    ...
    recordFinalScore(playerId, finalTime) {
