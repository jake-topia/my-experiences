class textBehavior extends ComponentScript {
  ...
  positionText() {
    ...
    // if (this.maxWrapAt && newWidth > this.maxWrapAt) newWidth = this.maxWrapAt;
    //
    ...
    //   newY = 0;
    //
    // if (this.justify === "start") newY = this.padding;
    // if (this.justify === "center")
    //   newY = this.engineHeight / 2 - this.sprite.height / 2;
    // if (this.justify === "end")
    //   newY = this.engineHeight - this.sprite.height - this.padding;
    //
    // if (this.align === "start") newX = this.padding;
    // if (this.align === "center") newX = this.engineWidth / 2 - newWidth / 2; // ← use
    //
    // if (this.align === "end") newX = this.engineWidth - newWidth - this.padding;
    //
