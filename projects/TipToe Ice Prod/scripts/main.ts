class main extends SystemScript {
  ...
  getValueAtId(id: string): boolean {
    ...
    if (tileNum == null && tileNum !== 0) return false;
  ...
  // analytics helper
  //
  profileIdHash:Record<string, string>
  logAnalyticPerPlayer(analyticName: "start" | "completion"){
  ...
  logJoinGameAnalytic(playerId:number){
